...
- Run `node dist/src/index.js --help` and confirm all commands (`add`, `list`, `done`, `delete`) are listed.
- Run `node dist/src/index.js add --help` (and other commands) and confirm command-specific help text is displayed.
